...
# --- Main Execution ---
print(f"Generating SQL schema file: {OUTPUT_FILENAME}...")

try:
    # Open the output file in write mode, using utf-8 encoding
    with open(OUTPUT_FILENAME, 'w', encoding='utf-8') as f:
        # Write the entire SQL schema string to the file
        f.write(sql_schema.strip()) # .strip() to remove potential leading/trailing whitespace
